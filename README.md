...
- **常见精品线路识别**：支持 `CMIN2`、`CMI`、`CMNET`、`CN2 GIA`、`CN2 GT`、`163`、`10099`、`9929`、`4837` 等线路，并允许为任意运营商选择全部预期线路，用于发现跨运营商绕行。
- **切线记录与通知**：监测任务和监测记录分开展示，支持多条件筛选、搜索和分页；事件保留完整 ASN 与探测路径，并可按确认次数和冷却时间发送切线、恢复通知。
